        ...
        <div class="row" >
            <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                              <a href=""><button type="button" class="btn btn-primary"><i class="fa fa-address-book" aria-hidden="true"></i> Add Contacts</button></a>
                            </li>
                        </ol>
            </div>
            <div class="col-lg-12">
		     
                      {!! Form::open(array('route' => 'dashboard.store', 'class' => 'form')) !!}
